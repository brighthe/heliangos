...
> 1. 先读 `https://raw.githubusercontent.com/brighthe/heliangos/main/ai/common/git-workflow.md` 的 §1、§3。
...
> 3. 我加完公钥后 `ssh -T git@github.com` 验证，再用 SSH 把需要的仓库（`brighthe/heliangos` 等）clone 到 `C:\workspace`。
